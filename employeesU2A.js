...
const employee1 = new Employee('Connor', ['monday', 'tuesday', 'wednesday', 'thursday'])
console.log(employee1.getSchedule())
/*
...
const manager1 = new Manager('John', ['monday', 'tuesday', 'wednesday', 'thursday'], employees)
manager1.getEmployees()
manager1.addEmployee('Connor')
manager1.getEmployees()
/*
    Create a new instance of your class.
...
//CODE HERE
const manager2 = new Manager('Winston',['weekday mornings, weekday afternoons'], ['Cece', 'Schmidt'])
