...
const newStatus = new Ticket('Chicken Nuggies', '2:03 AM', 'Lincoln',)

newStatus.updateStatus('on the way to your table')
...
//CODE HERE
const firstTicket = new Ticket('Pizza, bread, and Soda', '7:03 PM', 'Connor')

firstTicket.updateStatus('on the way to your table')
...
//CODE HERE
firstTicket.updateStatus('being cooked')